...
<div id="hotmenu" style="margin-left: 74px;">
	...
	<table style="width: 1092; margin-left: 74px;"> 
		<tr>
			<td colspan="5">
				<div id="image_list_1">
		        	<div class="clsBannerScreen" style="width: 1092px">
						<c:forEach var="httourist" items="${httourist }" begin="0" end="4">
							<div class="images" style="display:block">
							<img src="resources/upload/${httourist.hotimage }" width="1092px" height="600px">
						</div>
						</c:forEach>
					</div>
				</div>
 		...
 		<tr>
		<%	int a=0;
				List<Hot> ha = (List<Hot>)request.getAttribute("httourist");
