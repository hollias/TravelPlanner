        ...
        var oPoint = oCustomEvent.point;
         ...
         if (oTarget instanceof nhn.api.map.Marker) {
                 ...
                 mapInfoTestWindow.setContent('<DIV style="border-top: 1px solid; border-bottom: 2px groove black; border-left: 1px solid; border-right: 2px groove black; margin-bottom: 1px; color: black; background-color: white; width: auto; height: auto;">'+
                         ...
                         '<table style="background-color: white; width:250px;"><tr id="item"><td><img src="images/car4.jpg"></td><td><img id="btn" src="images/plus.jpg" onclick="appendItem(this)" width="30px" height="30px" class="image"><input type="hidden" class="local" value="'+oTarget.getTitle()+'" ><input type="hidden" id="mapx" value=""><input type="hidden" id="mapy" value=""><input type="hidden" name="plannerId" id="plannerId" value="${plannerId }"><input type="hidden" id="dday" value="${dday}"><input type="hidden" id="local1" value="${local1}"></td></tr><tr><td colspan="2"><div class="plus">'+oTarget.getTitle()+'</div></td></tr></table></span></div>');                 
